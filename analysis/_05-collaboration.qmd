...
Here therefore refer to the *development* lifespan of a project—measured here as the time between a repository's first and last commit—which is not necessary linked to its use-life.
The lifespan and activity of repositories in open-archaeo vary greatly (@fig-lifespan).
