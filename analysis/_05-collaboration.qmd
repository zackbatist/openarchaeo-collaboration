...
The lifespan and activity (commit rate) of repositories in open-archaeo vary greatly (@fig-lifespan).
Here we refer to the *development* lifespan of a project—measured here as the time between a repository's first and last commit—which is not necessary linked to its use-life.
The average project lasts <!-- TODO --> days with <!-- TODO --> commits per day.
<!-- TODO: turn all these percentages into code -->
Many projects are active for only a short period of time: about 15% less than a month, 25% less than three months, and 40% less than a year.
The longest are <!-- TODO -->.
Commit rates vary between <!-- TODO -->, with peaks at <!-- TODO -->.
