...
<!-- TODO: Abrupt transition, need to revise -->
...
However it is clear that only a small number of open-archaeo projects (<!-- TODO: do these share any characteristics in terms of platform or subject? -->) operate according to this model.
