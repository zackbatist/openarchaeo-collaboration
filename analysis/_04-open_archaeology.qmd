...
```{r data-licenses}
# open-archaeo_licenses.csv contains a list of licenses that had to be manually verified. This is necessary due to the fact that GitHub and CRAN have different conventions for naming the files containing the license.
