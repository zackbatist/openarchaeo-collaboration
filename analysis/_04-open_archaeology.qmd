...
```{r tbl-tags}
#| tbl-cap: Themes of open archaeology projects. See https://github.com/zackbatist/open-archaeo/blob/master/tags.md for a more comprehensive description of each tag's scope.
oarch |>
...
However, since around 2022, the number of new GitHub repositories has significantly plateaued, while the cumulative number of commits has continued to rise.
