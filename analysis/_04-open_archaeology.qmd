...
We found that the projects that host their code on GitHub use a wide variety of standard licenses.
However, nearly half of all repositories <!-- TODO: encode the percentage --> do not explicitly denote an open source license, or any license at all [@tbl-repo-licenses].
Maintainers may have assumed that making the code available, without explicitly stating permitting use, is enough to allow unrestricted access to the repository's contents.
...
<!-- TODO: Expand with additional info after seeing what is in the "other" category -->
