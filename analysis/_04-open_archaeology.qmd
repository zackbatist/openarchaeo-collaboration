...
Archaeologists have been using git from the early 2000s, before GitHub was launched,^[Commits dated to before GitHub's launch in 2008 come from repositories that were created earlier and later imported to GitHub's platform. We have excluded commits that have obviously erroneous dates, e.g. `2001-01-01` in projects started in the mid–late 2010s.].
