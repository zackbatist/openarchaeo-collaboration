...
1. Are there significant networks? If so, how big and how many?
  * Only one, it seems!
2. What proportion of users and repos are connected to this network?
3. What predicts membership in this network?
4. Does centrality in the network correlate with general rate of activity?
5. Who are the most central nodes in this network? Is there anything they have in common?
   * High activity?
