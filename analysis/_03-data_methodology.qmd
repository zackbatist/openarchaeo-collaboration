...
The full data and code is available in the compendium that accompanies this paper [@roe2023] <!-- reference should be updated to reflect the actual version number and date -->.
