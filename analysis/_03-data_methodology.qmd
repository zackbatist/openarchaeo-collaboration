...
if (!file_exists(cached_gh_data)) {
  oarch <- mutate(oarch,
                  gh_repo_info = map(gh_repo, gh_repo_info, .progress = TRUE),
                  gh_langs = map(gh_repo, gh_lang, .progress = TRUE),
                  gh_contribs = map(gh_repo, gh_contrib, .progress = TRUE),
                  gh_issues = map(gh_repo, gh_issue, .progress = TRUE),
                  gh_comments = map(gh_repo, gh_comment, .progress = TRUE),
                  gh_commits = map(gh_repo, gh_commit, .progress = TRUE),
  )
