...
tribble(
  ~term, ~definition,
  "Comment", "Text post attached to an issue, including the first one that describes the issue",
...
This does reduce our sample size slightly; about an eighth of projects don't use version control, at least not publicly, but among those that do, GitHub is by far the most popular host ([@tbl-repo-hosts]).
