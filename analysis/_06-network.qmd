...
<!-- TODO: Needs an update. These repos are no longer in the top 10, and it's probably best not to be so specific given how volatile that is. -->
...
Python projects in archaeology tend to be large, highly collaborative, and either infrastructural or of interest to other fields, so they have disproportionately high centrality.
Our findings support the notion that there are significant development patterns when working with these two languages, and further analysis to qualify this observation is warranted.
