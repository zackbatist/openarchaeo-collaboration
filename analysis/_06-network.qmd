...
From a two-mode network with edges representing users’ contributions to repositories (Figure 6), we derived two one-mode networks that render co-contributions as connections in themselves: repositories connected by common contributors (the repository–repository graph, presented in Figure 7), and users connected by contributions to common repositories (the user–user graph, presented in Figure 8).
